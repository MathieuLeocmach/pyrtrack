...
setup(
    ...
    version=pyrtrack.__version__,

    description='Multiscale tracking in Python',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/MathieuLeocmach/pyrtrack',
    ...
    install_requires=['numpy', 'scipy', 'numba', 'numexpr'],
